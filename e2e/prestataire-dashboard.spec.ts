...
test.describe('Prestataire Dashboard', () => {
  ...
  test('should display the dashboard with missions', async ({ page }) => {
    ...
    await expect(page.locator('[data-testid="en-cours-missions-list"] [data-testid="mission-card"]')).toHaveCount(0);
    await expect(page.locator('[data-testid="terminees-missions-list"] [data-testid="mission-card"]')).toHaveCount(0);
  });
  ...
  test('should accept a new mission', async ({ page }) => {
    await page.locator('[data-testid="nouvelles-missions-list"] [data-testid="mission-card"]').first().click();
